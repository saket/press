...
actual fun SpanPool.strikethrough(): WysiwygSpan = TODO()
actual fun SpanPool.inlineCode(): WysiwygSpan = TODO()
actual fun SpanPool.monospaceTypeface(): WysiwygSpan = TODO()
...
actual fun SpanPool.clickableUrl(url: String): WysiwygSpan = TODO()
actual fun SpanPool.thematicBreak(syntax: String): WysiwygSpan = TODO()
